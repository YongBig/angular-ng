					...
					createDateTimePicker = function(input) {
						...
						datetimepicker
							.on('xchange.xdsoft', function(event) {
								...
								xchangeTimer = setTimeout(function() {
									...
									if(isTwnty){//todo:dy 修改时间:2017/03/28  增加一条59分的变量
										time += '<div class="xdsoft_time ' + '" data-hour="' + 23 + '" data-minute="' + 59 + '">' + "23:59" + '</div>';
						...
						calendar
							.on('touchend click.xdsoft', 'td', function(xdevent) {
								...
								input.val(_xdsoft_datetime.str());
								//scope.timer = _xdsoft_datetime.str(); //向input赋值
								//scope.$apply();
